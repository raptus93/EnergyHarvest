		...
		try
		{
			...
			poiDescription.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v)
				{
					...
					/*
					 * Object tag = tv.getTag(); boolean expanded = tag != null?(Boolean) tag:false;
					 * tv.setTag(!expanded); if (!expanded) expand(tv); else collapse(tv);
					 */
...
//							textdescription.setText(mChannel.getDescription());
//							tv.invalidate();
						}
